...
| Share Kokoro safely | `/kokoro-share-readiness` | Available | `/kokoro-share-readiness` | no guest data, no credentials, no runtime state |
...
Ruta principal: `/kokoro-weekly-marketing-run` (available)
Disponible ahora: `/kokoro-weekly-marketing-run`

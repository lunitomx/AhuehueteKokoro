---
name: seo-webdev
description: On-page SEO optimization from Addy Osmani's web-quality-skills. Code-level fixes for meta tags, structured data, heading hierarchy, link text, and crawlability. Use when asked to "fix SEO code", "optimize meta tags", "add structured data to code", or "SEO code review".
license: MIT
metadata:

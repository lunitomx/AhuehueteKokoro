# Epic E46: Parrilla 2.0 — Metodología Battle-Tested

> **Status:** IN PROGRESS
> **Created:** 2026-06-09
> **Origin:** Documento interno de metodología de parrilla (caso real anonimizado)
...
real de un cliente reveló. E46 incorpora 6 patrones battle-tested:
...
| S46.2 | Trigger Events vs Attributes | M | Metodología para convertir atributos fríos en trigger events de vida/mentalidad. Con ejemplos reales: "X residencias" → "no se siente como torre llena de gente". |
...
### In scope (SHOULD)
- Ejemplos multi-idioma (inglés que no suene traducido ni inmobiliario)
...
### Per story
- [ ] 4-layer protocol documented with anonymized examples
...
| Risk | Mitigation |
|------|------------|
| Metodología muy ligada a un caso específico | Abstraer los patrones (trigger events, 4-column, unique mechanism) — los ejemplos son anonimizados, la estructura es universal |
